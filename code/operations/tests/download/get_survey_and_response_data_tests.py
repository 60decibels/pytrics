...
from qualtrics_api.operations.download import get_survey_and_response_data
...
class GetSurveyAndResponseDataTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        save_responses_to_s3_patch = patch('qualtrics_api.operations.download.save_responses_to_s3')
        self.save_responses_to_s3 = save_responses_to_s3_patch.start()
        self.addCleanup(save_responses_to_s3_patch.stop)

        _unzip_response_file_patch = patch('qualtrics_api.operations.download._unzip_response_file')
    ...
    def test_calls_expected_functions_when_successful(self):
        # run the function
        get_survey_and_response_data('SV_abcdefghijk', True)
