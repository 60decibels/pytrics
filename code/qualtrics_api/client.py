...
class QualtricsAPIClient():
    ...
    def build_question_display_logic(self, controlling_question_id, choices, operator, conjunction=None, locator=None): # pylint: disable=too-many-arguments
        try:
            assert controlling_question_id.strip()
            assert choices
            ...
            raise AssertionError('You must provide a string value for controlling_question_id, an non-empty array for choices and supported values for operator, conjunction and locator')
        ...
        if include_display_logic:
            ...
            if 'display_logic' in question_params.keys():
                ...
                if question_display_logic_dict:
                    ...
                    operator = question_display_logic_dict['operator']
                    conjunction = question_display_logic_dict['conjunction']
                    locator = question_display_logic_dict['locator']
